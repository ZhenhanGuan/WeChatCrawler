...
class WeChatArticleCrawler:
    def __init__(self, keywords=None, file_path=None, comparison_date_str="2025-07-02"):
...
if __name__ == "__main__":
    ...
    crawler = WeChatArticleCrawler(keywords=keywords, file_path=file_path, comparison_date_str=comparison_date_str)
    crawler.crawl()
